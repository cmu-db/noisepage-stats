...
class ArtifactStatsViewTest(APITransactionTestCase):

    test_username = 'testuser'
    test_password = 'password'

    def setUp(self):
        self.url = '/performance-results/artifact-stats/'
    ...
    def test_invalid_data_num_validation_rules(self):
        ...
        response = self.client.post(
            self.url, data={'noneya': 'business'}, format='json')
        self.assertContains(response, 'required', count=3, status_code=400)
