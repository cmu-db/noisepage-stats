...
# testing env
TESTING_DB_USER="$(cat testing/pss_db_user)"
TESTING_DB_PASSWORD="$(cat testing/pss_db_password)"
TESTING_DB_HOST="incrudibles-testing.db.pdl.cmu.edu"
TESTING_DB_PORT="30003"
TESTING_DB_NAME="postgresql://$TESTING_DB_USER:$TESTING_DB_PASSWORD@$TESTING_DB_HOST:$TESTING_DB_PORT/pss_database?sslmode=disable"
# staging env
STAGING_DB_USER="$(cat staging/pss_db_user)"
STAGING_DB_PASSWORD="$(cat staging/pss_db_password)"
STAGING_DB_HOST="incrudibles-staging.db.pdl.cmu.edu"
STAGING_DB_PORT="31003"
STAGING_DB_NAME="postgresql://$STAGING_DB_USER:$STAGING_DB_PASSWORD@$STAGING_DB_HOST:$STAGING_DB_PORT/pss_database?sslmode=disable"
# production env
PRODUCTION_DB_USER="$(cat production/pss_db_user)"
PRODUCTION_DB_PASSWORD="$(cat production/pss_db_password)"
